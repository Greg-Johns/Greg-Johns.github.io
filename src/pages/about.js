    ...
    return (
      <div className='mainGrid'>
        ...
        <article>
          ...
          <p>A year later I graduated with an art degree and tried the starving artist thing, worked as a print designer and side gigged as a assistant inker on an actual  published comic book. I saved enough for a <a href='https://en.wikipedia.org/wiki/Macintosh_clone'>Mac clone</a> and continued to follow my interests in web development and interaction design. On the side I started designing and building websites for small to mid sized companies around Dallas.</p>
          ...
          <p>In 1997 I worked as a designer for Ernst & Young. Their I was recognized as one who could not only work with stakeholders to help realize and design their ideas but also one who could turn those ideas into working code. As my fascination with computers and programming grew I moved into a more design/prototype role and helped projects move faster from idea to wire frame to working prototypes. But being ever curious it was only a matter of time before I worked my way back to the server, database and analytics layer of software development. I've been working in the field of user experience and/or front end/full stack web development.</p>
